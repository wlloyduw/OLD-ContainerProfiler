...
DOCKERCMD="sudo docker run -v /home/david/ContainerProfiler/profiler_demo/sleep_test/new_process_test/pgbench_remotehost:/data -e NWELLS=$NWELLS geoclaw_test"
